...
export type FileState = {
  ...
  url: string; // Expanded functionality: added to keep track of all uploaded files
  size: number; // Expanded functionality: added to keep track of uploaded file size
};
...
const ERROR_MESSAGES = {
  ...
  tooManyFiles(maxFiles: number) {
    return `Sorry, you can upload a maximum of ${maxFiles} files.`;
  },
  fileNotSupported() {
